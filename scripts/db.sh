...
PGPASSWORD=password psql -h 127.0.0.1 -p 5432 -f scripts/create_tables.sql gisproject gis_project_user
...
PGPASSWORD=password psql -h 127.0.0.1 -p 5432 -f scripts/create_network_topology.sql gisproject gis_project_user
